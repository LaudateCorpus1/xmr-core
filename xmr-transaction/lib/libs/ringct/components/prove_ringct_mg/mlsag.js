...
function MLSAG_Gen(message, pk, xx, kimg, index, hwdev) {
    return __awaiter(this, void 0, void 0, function* () {
        xmr_str_utils_1.JSONPrettyPrint("MLSAG_Gen", {
            message,
            pk,
            xx,
            kimg,
        ...
        const { a, aG, aHP } = yield hwdev.mlsag_prepare(Hi, xx[0]);
        ...
        xmr_str_utils_1.JSONPrettyPrint("MLSAG_Gen", { alpha, toHash, c_old }, "secret index section");
        i = (index + 1) % cols;
        if (i === 0) {
            rv.cc = c_old;
        }
        while (i != index) {
            ...
            c_old = yield hwdev.mlsag_hash(toHash); //hash to get next column c
            i = (i + 1) % cols;
            if (i === 0) {
                rv.cc = c_old;
            }
            xmr_str_utils_1.JSONPrettyPrint("MLSAG_Gen_post_iteration", { alpha, toHash, c_old }, `iteration ${i}`);
        }
        yield hwdev.mlsag_sign(c_old, xx, alpha, rows, 1, rv.ss[index]);
        xmr_str_utils_1.JSONPrettyPrint("MLSAG_Gen", {
            rv,
        }, "ret");
        return rv;
...
exports.MLSAG_ver = MLSAG_ver;
//# sourceMappingURL=mlsag.js.map
