...
export declare type EcScalar = string;
export declare type EcPoint = string;
export declare type SecretKey = EcScalar;
export declare type PublicKey = EcPoint;
export declare type SecretKeys = {
    viewKey: EcScalar;
    spendKey: EcScalar;
};
export declare type KeyDerivation = EcPoint;
export declare type ChachaKey = string;
export declare type PublicSpendKey = PublicKey;
...
export declare type CtKeyV = CtKey[];
export declare type Key = PublicKey | SecretKey;
export declare type KeyV = Key[];
export declare type Hash8 = string;
...
export interface HWDevice {
     ...
     * @memberof HWDevice
     */
    put_key(privViewKey: string, pubViewKey: string, privSpendKey: string, pubSpendKey: string, b58PubKey: string): Promise<boolean>;
    /**
     *
     ...
     * @memberof Device
     */
    conceal_derivation(derivation: KeyDerivation, tx_pub_key: PublicKey, additional_tx_pub_keys: PublicKey[], main_derivation: KeyDerivation, additional_derivations: KeyDerivation[]): Promise<PublicKey>;
    /**
     *
     ...
     * @memberof Device
     */
    mlsag_prehash(blob: string, inputs_size: number, outputs_size: number, hashes: KeyV, outPk: CtKeyV): Promise<Key>;
    /**
     *
