...
import { Pid, ViewSendKeys } from "../../../xmr-transaction";
import { MyMoneroApi } from "../";
import { selectOutputsAndAmountForMixin } from "./internal_libs/output_selection";
import { NetType, HWDevice } from "../../../xmr-crypto-utils";
export declare function estimatedTransactionNetworkFee(nonZeroMixin: number, feePerKB: BigInt, simplePriority: number): import("../../../biginteger/vendor/biginteger").BigInteger;
